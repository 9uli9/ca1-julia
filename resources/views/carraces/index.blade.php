                            ...
                            <tbody>
                                @forelse($carRaces as $carRace)
                                    <tr class="bg-black dark:bg-black-800 border-b border-white-100 dark:border-white-700">
                                        ...
                                        <td class="px-6 py-4 font-medium text-red-900 whitespace-nowrap dark:text-white">
                                            {{ $carRace->driver->first_name }} 
                                        </td>
                                        
                            
                                        <td class="px-6 py-4 font-medium text-red-900 whitespace-nowrap dark:text-white">
                                            <a href="{{ route('carraces.show', ['carrace' => $carRace->id]) }}" class="font-medium text-yellow-600 dark:text-yellow-500 hover:underline">Show</a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
